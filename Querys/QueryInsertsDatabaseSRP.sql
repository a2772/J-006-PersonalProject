...
INSERT INTO datos_personales(nombre, primer_apellido, segundo_apellido, fecha_nacimiento, sexo, direccion, curp) VALUES
	('Paris', 'Ramírez', 'Saldaña', '2001-05-27', 'Hombre', 1, null);

SELECT * FROM datos_personales;
DELETE FROM datos_personales WHERE id = 3;